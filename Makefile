#############################################################################
# Makefile for building: QtFileManager
# Generated by qmake (3.1) (Qt 6.8.2)
# Project:  QtFileManager.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile QtFileManager.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = QtFileManager1.0.0
DISTDIR = /home/ptr/Developement/guided/FilemanProjects/RenameManager/.tmp/QtFileManager1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: QtFileManager.pro /usr/lib64/qt6/mkspecs/linux-g++/qmake.conf /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile QtFileManager.pro

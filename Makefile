...
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile QtFileManager.pro
#############################################################################
...
DISTDIR = /home/runner/work/FileMisc/FileMisc/.tmp/QtFileManager1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: QtFileManager.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
